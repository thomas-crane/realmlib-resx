...
/**
 * A static class used to download the latest game resources and packet ids.
 */
export class ResX {
  /**
   ...
   */
  static getClientVersion(): Promise<string> {
   ...
   */
  static getAssetVersion(): Promise<string> {
   ...
   */
  static getVersions(): Promise<VersionInfo> {
    return Promise.all([
   ...
   */
  static extractPacketInfo(source: string): PacketMap {
